...
class Data:
    ...
    # About Message
    ABOUT = "**About This Bot** \n\nThis is an Unzip bot by @Regaltos_botz \n\nChannel Link : [Click Here](https://t.me/Regaltos_botz) \n\nFramework : [Pyrogram](docs.pyrogram.org) \n\nLanguage : [Python](www.python.org) \n\nDeveloper : [I'MGHOST](https://t.me/Godofwar_033)"
...
- uploaded so far with number of the file being uploaded.

It doesn't take too much time than other mode and is the recommended method. 

2) ** Rabbit 🐇**
Bit Fast but have less friendly UI.
...
This is bit fast but only recommended for larger files as smaller files won't have much time difference.   
    ...
    buttons = [
        ...
        [InlineKeyboardButton("♥ More Amazing bots ♥", url="https://t.me/Regaltos_botz")],
        [InlineKeyboardButton("🎨 Support Group 🎨", url="https://t.me/Regaltos_Botz_Support")],
    ]